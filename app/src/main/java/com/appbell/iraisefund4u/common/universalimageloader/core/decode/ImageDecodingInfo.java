...
import com.appbell.iraisefund4u.common.universalimageloader.core.DisplayImageOptions;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.appbell.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
